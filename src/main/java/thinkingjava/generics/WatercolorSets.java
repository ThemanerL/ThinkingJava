...
import thinkingjava.generics.watercolors.Watercolors;

import java.util.EnumSet;
import java.util.Set;

import static thinkingjava.generics.watercolors.Watercolors.*;
import static thinkingjava.net.mindview.util.Sets.*;
