...
public class EmployeeLambdaTest {
  ...
  public void filterEmployee() {
    ...
    List<Employee> empList = getResultByCondition(Employee.employees, new FilterByAge());
    empList.forEach(System.out::println);
    System.out.println("----------1.2----------");
    empList = getResultByCondition(Employee.employees, new FilterBySalary());
    empList.forEach(System.out::println);
    // 第二种方式
    System.out.println("----------2.1----------");
    empList = getResultByCondition(Employee.employees, new Predicate<Employee>() {
      @Override
    ...
    empList = getResultByCondition(Employee.employees, (e) -> e.getAge() > 18);
    empList.forEach(System.out::println);
    // 第四种方式
